        ...
        if (bot == null) {
            ...
            switch (choice) {
                case (1):
                    ...
                    break;
                case (2):
                    success = this.bolster(1,bot);
                    if (success) this.playCard();
                    break;
                case (3):
                    success = this.guide(1,bot);
                    if (success) this.playCard();
                    break;
            }
        } else {
            ...
            boolean willGuide = Integer.parseInt(choices.substring(39,40)) == 1;
            ...
            if (willGuide) {
                success = this.guide(1,bot);
                System.out.println( bot.getName() + ": tried guiding" );
                if (success) {
                    this.playCard();
                    System.out.println( bot.getName() + ": success" );
                }
